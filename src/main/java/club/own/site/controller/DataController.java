...
public class DataController extends BaseController{
    ...
    public String disk() throws Exception {
        ...
        for (OSFileStore fs : fsArray) {
            ...
            diskInfo.setTotal(NumberUtils.formatFloat(total / 1024d /1024d / 1024d / 10d));
            diskInfo.setFree(NumberUtils.formatFloat(usable / 1024d /1024d / 1024d  / 10d));
            diskInfo.setUsed(NumberUtils.formatFloat((total - usable) / 1024d /1024d / 1024d  / 10d));
